...
package artcustomer.maxima.extensions.display.ui.list.layout {
	 ...
	 */
	public class HorizontalListLayout extends AbstractListLayout implements IListLayout {
		 ...
		 * Constructor
		 */
		public function HorizontalListLayout() {
			super();
		}
		...
		public function display():void {
			...
			for (i ; i < length ; i++) {
				...
				if (i != 0) {
					...
					item.x = lastItem.x + lastItem.width + _margin;
				}
			}
		}
